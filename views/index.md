...
<section class="mycard home container-fluid grid" id="card1">
  ...
  <button class="outline contrast" onclick="location.href='mailto:info@flyvfc.com'" type="button"><img src="assets/mail.svg"> info&#65279;@flyvfc.com</button>
  <button class="outline contrast" onclick="location.href='tel:+12506562833'" type="button"><img src="assets/phone.svg"> (250) 656 - 2833</button>
...
<section class="mycard home container-fluid grid" id="card4">
  ...
  <button class="outline contrast" onclick="location.href='/resources'" type="button" target="_blank">_Resources_</button>
